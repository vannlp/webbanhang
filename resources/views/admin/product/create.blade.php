                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6 form-group">
                                ...
                                <input type="text" value="{{old('code')}}" class="form-control" name="code" id="code" placeholder="Mã code"> 
                            </div>
                            <div class="col-6 form-group">
                                <label for="slug">Đường dẫn</label>
                                <input type="text" value="{{old('slug')}}" class="form-control" name="slug" id="slug" placeholder="Slug"> 
                            </div>
                            <div class="col-12 form-group">
                                <label for="name">Tên sản phẩm</label>
                                <input type="text" value="{{old('name')}}" class="form-control" name="name" id="name" placeholder="Tên sản phẩm"> 
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input type="number" value="{{old('price_down')}}"  class="form-control" id="price" name="price_down">
                            </div>

                            <div class="col-12 form-group">
                                <label for="short_description">Mô tả ngắn</label>
                                <textarea name="short_description" placeholder="mô tả ngắn" class="form-control" id="short_description" cols="30" rows="10">{{old('short_description')}}</textarea>
                            </div>

                            <div class="col-12 form-group">
                                <label for="">Mô tả</label>
                                <textarea id="editer" name="description">{{old('description')}}</textarea>
